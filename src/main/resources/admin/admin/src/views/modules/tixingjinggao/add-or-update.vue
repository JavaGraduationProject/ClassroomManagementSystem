            ...
            <el-col :span="24">
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.tixingneirong" label="提醒内容" prop="tixingneirong">
                    <span v-html="ruleForm.tixingneirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.tixingneirong = this.ruleForm.tixingneirong.replace(reg,'../../../springboot65sq2/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `tixingjinggao/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.tixingjinggaoCrossAddOrUpdateFlag = false;
                  this.parent.search();
